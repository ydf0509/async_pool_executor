...
setup(
    name='async_pool_executor',  #
    version="0.1",
    description=( 'async_pool_executor,its api like the concurrent.futures'),
...
python setup.py sdist & twine upload dist/async_pool_executor-0.1.tar.gz
twine upload dist/*
